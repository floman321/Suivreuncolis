        ...
        <div class="input-group pull-right" style="display:inline-flex">
			<span class="input-group-btn">
				<a class="btn btn-default btn-sm eqLogicAction roundedLeft" data-action="configure"><i
                            class="fa fa-cogs"></i> {{Configuration avancée}}</a><a
                        class="btn btn-default btn-sm eqLogicAction" data-action="copy"><i class="fas fa-copy"></i> {{Dupliquer}}</a><a
                        class="btn btn-sm btn-success eqLogicAction" data-action="save"><i
                            class="fas fa-check-circle"></i> {{Sauvegarder}}</a><a
                    ...
                    <fieldset>
                        ...
                        <div id="colis">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" id="numcolis" class="eqLogicAttr configuration form-control"
                                           data-l1key="configuration" data-l2key="numsuivi" placeholder="N° Suivi"/
                                    onblur="rechercher(<?php echo config::byKey('api_aftership', 'suivreuncolis', ''); ?>);">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="eqLogicAttr configuration form-control"
                                           data-l1key="configuration" data-l2key="commentaire"
                                           placeholder="Destination, Nom du E-Commerce ..."/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select id="sel_object" class="eqLogicAttr form-control" data-l1key="configuration"
                                            data-l2key="transporteur" onchange="transporteurchange(this);">
                        ...
                        <div id="aftership" style="display:none;">
                            ...
                            <p>Vous devez avoir une cle API pour utiliser ce service (voir <a
                                        href='https://secure.aftership.com/apps/api'>https://secure.aftership.com/apps/api</a>)
                            <p>Cette partie n'est pas obligatoire dans jeedom (utilisé pour auto création dans
                                AfterShip)</p>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">Transporteur AfterShip</label>
                                <div class="col-sm-3">
                                    <select id="ListeTransporteurs" class="eqLogicAttr form-control"
                                            data-l1key="configuration" data-l2key="transaftership">
                                        <option value=''></option>
                                        ...
                                        <option value='gls-slovakia'>GLS General Logistics Systems Slovakia s.r.o.
                                        </option>
                                        ...
                                        <option value='intel-valley'>Intel-Valley Supply chain (ShenZhen) Co. Ltd
                                        </option>
                                        ...
                                        <option value='linkbridge'>Link Bridge(BeiJing)international logistics co.
                                        </option>
                                        ...
                                        <option value='tuffnells-reference'>Tuffnells Parcels Express- Reference
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="eqLogicAttr configuration form-control"
                                           data-l1key="configuration" data-l2key="cp_aftership"
                                           placeholder="Code Postal destination "/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">Mot de passe (Ex NomExpediteur) (si
                                    nécessaire)</label>
                                <div class="col-sm-3">
                                    <input type="text" class="eqLogicAttr configuration form-control"
                                           data-l1key="configuration" data-l2key="trackingkey_aftership"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr"
                                                                          ...
                                                                          data-l2key="autocreate" unchecked/></label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <label class="checkbox-inline"><input type="checkbox" class="eqLogicAttr"
                                                                          data-l1key="configuration"
                                                                          data-l2key="autodelete" unchecked/></label>
                                </div>
                            </div>
